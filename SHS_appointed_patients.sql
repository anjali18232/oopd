...
DROP TABLE IF EXISTS `appointed_patients`;
...
LOCK TABLES `appointed_patients` WRITE;
/*!40000 ALTER TABLE `appointed_patients` DISABLE KEYS */;
/*!40000 ALTER TABLE `appointed_patients` ENABLE KEYS */;
UNLOCK TABLES;
