...
LOCK TABLES `rooms_available` WRITE;
/*!40000 ALTER TABLE `rooms_available` DISABLE KEYS */;
INSERT INTO `rooms_available` VALUES (1,97,'1');
/*!40000 ALTER TABLE `rooms_available` ENABLE KEYS */;
UNLOCK TABLES;
